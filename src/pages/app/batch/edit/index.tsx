...
const EditBatch = (props: any) => {
  ...
  console.log('prog',progname)
  // const [oldData,setOldData]:any = useState(null)

  // const location = useLocation()
  // const data1:any = location.state?.data

  // console.log('prog',progname)
  useEffect(() => {
    dispatch(reqGetBootcampById(5))
    dispatch(reqGetProgName())
    console.log('bootcampnya',bootcamp)
    console.log('prognamenya',progname)
  },[])

  // const [batchId, setBatchId] = useState<number | number[] | undefined>(
  //   undefined
  // );
  ...
  // useEffect(() => {
    // if (typeof batch_id === 'string') {
      // Jika batch_id adalah string, maka nilai valid tersedia
      // console.log('pathname', pathname)
      // setBatchId(+lastPart);
      // console.log('idnya', typeof batchId, batchId)
    // if (id) {
      // console.log('boot',bootcamp)
      // dispatch(reqGetBootcampById(batchId));
      // dispatch(reqGetProgName());
    // }
    // console.log('prog', progname);
    // }
      // console.log('idnya',lastPart)
    // Memanggil fungsi fetchBootcampData saat komponen pertama kali dirender dan setiap kali nilai refresh berubah
  // }, []);
          ...
          >
            <div className=" rounded p-4 flex items-center relative ">
              <div className="w-2/6">
                <TextField
                  ...
                  className="w-full "
                  {...register("batchname", registerOptions.batchname)}
                  // defaultValue={bootcamp?.batch_name}
                />
              </div>
            ...
            <div className="flex flex-wrap w-full items-center justify-center">
              {(currentData || []).map((user) => (
                //selectedMembers digunakan jika sudah ada datanya
                <Card
                  key={user.id}
