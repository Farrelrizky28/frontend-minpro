...
const Edit = () => {
  ...
  useEffect(() => {
    ...
    const handleRegister = async (data: FormValues) => {
        const item_include = "20" //benefit
        const requirement = "requirement" //persyaratan
    ...
    // useEffect(() => {
    //     setLoadedData(entity_id)
    //     console.log("LOADEDDDDD", loadedData);
    // }, [entity_id])

    // console.log("lola", loadedData);
    const {
        register,
        setValue,
        handleSubmit,
