...
export const reqGetSectionMerge = () =>{
 ...
 export const resDeleteCurri = (payload:any) =>{
    return{
      type: actionType.RES_DELETE_CURRICULUM,
      payload
    }
  }

 export const reqDeleteCurri = (payload:any) =>{
    return{
      type: actionType.REQ_DELETE_CURRICULUM,
      payload
    }
  }